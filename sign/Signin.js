...
function Signin() {
    ...
    return (
        <div className="wrapper"> {/* 이 div에 wrapper 클래스를 적용합니다. */}
            <div className={`sign-container ${isRightPanelActive ? 'right-panel-active' : ''}`} id="container">
                <div className="form-container sign-up-container">
                    <form onSubmit={handleSignup} className="signin-form">
                        ...
                        <input className="sign-input" type="text" placeholder="ID" value={id} onChange={(e) => setId(e.target.value)} required/>
                        <input className="sign-input" type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)}
                               required/>
                        <button type="submit" className="form_btn sign-button">Sign Up</button>
                    </form>
                </div>
                ...
                <div className="form-container sign-in-container">
                    <form onSubmit={handleSignin} className="signin-form">
                        ...
                        <input className="sign-input" type="text" placeholder="ID" value={id} onChange={(e) => setId(e.target.value)}
                               required/>
                        <input className="sign-input" type="password" placeholder="Password" value={password}
                               onChange={(e) => setPassword(e.target.value)} required/>
                        <button type="submit" className="form_btn sign-button">Sign In</button>
                    </form>
                </div>
                <div className="overlay-container">
                    <div className="overlay">
                        <div className="overlay-panel overlay-left">
                            ...
                            <button className="overlay_btn sign-button" onClick={() => setIsRightPanelActive(false)}>Sign In</button>
                        </div>
                        <div className="overlay-panel overlay-right">
                            ...
                            <button className="overlay_btn sign-button" onClick={() => setIsRightPanelActive(true)}>Sign Up</button>
                        </div>
                    </div>
                </div>
            </div>
